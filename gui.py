...
def clean2_plate(plate):
    """
    This function cleans the license plate by thresholding and finding the contour with maximum area. 
    It returns the cleaned image and the bounding rectangle coordinates of the license plate.
    """
    ...
    if num_contours:
        ...
        # Checking if the contour satisfies aspect ratio and area criteria
...
def ratioCheck(area, width, height):
    """
    This function checks if the contour satisfies the aspect ratio and area criteria.
    """
...
def isMaxWhite(plate):
    """
    This function checks if the license plate image has maximum white pixels.
    """
    avg = np.mean(plate)
    if(avg>=115):
        return True
...
def ratio_and_rotation(rect):
    """
    This function checks if the contour satisfies the aspect ratio and rotation angle criteria.
    """
...
def classify(file_path):
    """
    This function loads the image from the given file path and performs license plate recognition using image processing techniques.
    """
    res_text=[0]
    res_img=[0]
